        ...
        <section id="about" className="about-section">
          <div className="about-content">            
            ...
            <h1 className='anton-sc-regular'>About Me</h1>
              ...
              <p>I've already worked on a few projects where I've worked on various technologies. My hobbies includes coding,travelling & Content Writting.</p> <br />
              <p>I am not content with just the basics. I am eager to learn more about Web3.0 technologies and DevOps. I am seeking the opportunity to work with a team of experienced Web developers and contribute to real-world projects.</p>
